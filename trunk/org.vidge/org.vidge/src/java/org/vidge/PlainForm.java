...
import org.vidge.controls.adapters.FieldAdapterTreeList;
			...
			for (PropertyController controller : getControllerList()) {
				try {
					if (controller.getExplorer().isEmbedded()) {
						...
						if (controller.getFieldAdapter().getClass().equals(FieldAdapterList.class) || controller.getFieldAdapter().getClass().equals(FieldAdapterTreeList.class)) {
