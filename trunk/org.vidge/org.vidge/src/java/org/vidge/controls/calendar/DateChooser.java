...
public class DateChooser extends Composite {
	...
	private String[] labels = new String[] {
			...
			Messages.DateChooser_second
	};
	private String[] separators = new String[] {
			Messages.DateChooser_date_separator, Messages.DateChooser_date_separator, StringUtil.SP2, Messages.DateChooser_time_separator, ":", StringUtil.NN
	};
			...
			public void widgetSelected(SelectionEvent e) {
				...
				ok.addSelectionListener(new SelectionAdapter() {
					...
					public void widgetSelected(SelectionEvent e) {
						...
						System.out.println("Time selected (HH:MM) = " + time.getHours() + ":" + (time.getMinutes() < 10 ? "0" : StringUtil.NN)
							+ time.getMinutes());
						dialog.close();
					}
				});
