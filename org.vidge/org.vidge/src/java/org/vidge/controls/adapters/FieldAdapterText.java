...
public class FieldAdapterText extends AbstractFieldAdapter implements KeyListener, ModifyListener {
	...
	protected void createControl(Composite parent) {
		text = new TextField(parent, ((controller.getControlType() == VisualControlType.TEXTAREA) ? (SWT.WRAP | SWT.MULTI | SWT.V_SCROLL) : SWT.SINGLE),
			controller);
	...
	public void modifyText(ModifyEvent e) {
		// System.out.println("--------------modifyText--------" + getExplorer().getLabel());
	...
	public void inValidate() {
		// System.out.println("--------------inValidate--------" + getExplorer().getLabel());
		super.inValidate();
