...
public class PageManager {
	...
	private static final String COUNT2 = Messages.PageManager_1;
	...
	public PageManager(final Composite parent, int style) {
		...
		itemNext.setToolTipText(Messages.PageManager_6);
		...
		item.setToolTipText(Messages.PageManager_7);
		...
		countCombo.setToolTipText(Messages.PageManager_2);
		countCombo.select(0);
		...
		countCombo.addKeyListener(new KeyListener() {
			...
			public void keyPressed(KeyEvent e) {
				...
				if (e.character == CHAR) {
					e.doit = true;
					countCombo.setText(StringUtil.NN);
				}
			}
	...
	private void showLabel() {
		propsLabel.setText(StringUtil.SP2 + from + StringUtil.SP2);
	}
	...
	public void setItemsCount(int totalItemsCount) {
		...
		from = FIRST_ELEMENT;
		countLabel.setText(StringUtil.SP2 + totalItemsCount + StringUtil.SP2);
		showLabel();
		parentPane.pack();
	}
	...
	public void setCountValues(int[] countValues) {
		...
		for (int dd : countValues) {
			countCombo.add(dd + StringUtil.NN);
		}
		countCombo.select(0);
	}
}
