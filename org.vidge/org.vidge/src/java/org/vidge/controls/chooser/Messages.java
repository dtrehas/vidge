...
public class Messages extends NLS {
	...
	public static String PageManager_1;
	public static String PageManager_2;
	public static String PageManager_3;
	public static String PageManager_4;
	public static String PageManager_5;
	public static String PageManager_6;
	public static String PageManager_7;
