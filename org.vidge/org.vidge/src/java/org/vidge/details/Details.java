...
public class Details {
	...
	public void putList(String name, Collection values) {
		properties.add(new DetailProperty(name, StringUtil.NN));
		for (Object obj : values) {
			properties.add(new DetailProperty(StringUtil.NN, checkValue(obj)));
		}
	}
	...
	public void putProperty(String name, Object value, IAction action) {
		if (value instanceof Collection) {
			...
			for (Object obj : (Collection) value) {
				properties.add(new DetailProperty(StringUtil.NN, checkValue(obj), action));
			}
		} else {
